...
export default function Projetos() {
  ...
  return (
    <section id="projetos" ref={containerRef} className="relative z-10 flex min-h-fit w-full flex-col items-center justify-start px-6 py-10 md:px-10 lg:pt-24 lg:pb-32">
      <div className="projetos-wrapper mx-auto flex w-full max-w-6xl flex-col items-center gap-8 lg:gap-12">
        
        <h2 className="projetos-title text-balance text-4xl font-semibold tracking-tighter-custom text-white md:text-5xl lg:text-6xl text-center">
        ...
        <div className="flex w-full flex-col space-y-24 lg:space-y-32">
          ...
          {/* Project 2 (Card Left, Image Right) - Removed */}
